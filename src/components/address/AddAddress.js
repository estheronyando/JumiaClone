...
import { kenyanCounties } from "../../constants/data";
...
function AddAddress() {
  const [kenyanCounties, setkenyanCounties] = useState("Gujarat");
  ...
  const handleDropDown = (event) => {
    setkenyanCounties(event.target.value);
  };
